    ...
    <div class="row">
        ...
        <div class="col-1">
            <form action="/admin/action.php" method="POST">
                ...
                <input type="hidden" name="action" value="stuallow">
                <button class="bg-primary btn" style="margin-right:20px;color:white"  type="submit">Allow</button>
            </form>
        </div>
        <div class="col-1">
            <form action="/admin/action.php" method="POST">
                <input type="hidden" name="id" value="<?php echo($id) ?>">
                <input type="hidden" name="action" value="studel">
