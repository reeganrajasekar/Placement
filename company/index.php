        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <a href="/company" class="nav-item nav-link active">Company</a>
                </div>
            </div>
        </nav>
        <!-- Navbar End -->
      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card border-3 shadow rounded-400 my-5">
          <div class="card-body p-4 p-sm-5">
            <h5 class="card-title text-center mb-5 fw-light " ><b>Company Login</b></h5>
            <h5 class="card-title text-center mb-5 fw-light " style="color:red"><?php if (isset($_GET["data"])) {
              echo $_GET["data"];
            } ?></h5>
            <form action="/company/login.php" method="POST">
              ...
              <hr class="my-4">
                <h5 class="card-title text-center">Don't have an account? <a href="/company/signup.php" style="color:#00B074">Signup!</a></h5>  
            </form>
          </div>
        </div>
      </div>
