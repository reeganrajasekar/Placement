...
<div class="container bg-text">
    <div class="row">
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card border-1 shadow rounded-1 my-2" >
          <div class="card-body p-4 p-sm-5">
            <h5 class="card-title text-center mb-5 fw-light "><b>Company Signup</b></h5>
            <form action="/company/create.php" method="POST">
            <div class="form-floating mb-3">
                <input type="text" required class="form-control" name="name" id="floatingInput" placeholder="name@example.com">
