      ...
      <div class="col-sm-10 col-md-9 col-lg-8 mx-auto" style="border-radius:25px;">
        <div class="card border-1 shadow rounded-400 my-5">
          <div class="card-body p-4 p-sm-5">
            <h5 class="card-title text-center mb-5 fw-light " ><b>Student Login</b></h5>
            ...
            <form action="/check.php" method="POST">
              ...
              <br>
              <div class="d-grid">
                <button class="btn btn-primary btn-login text-uppercase fw-bold" style="background-color:#00B074" type="submit">Login</button>
              </div>
              <br>
              <hr>
            <h5 class="card-title text-center fw-light " >Don't You have an account? <a href="/signup.php">Signup !</a></h5>
            </form>
          </div>
        </div>
      </div>
